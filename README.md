...
- **Repository:** [rafsilva85/skillflow-mcp-server](https://github.com/rafsilva85/skillflow-mcp-server)
- **Description:** Browse, search, and discover AI agent skills from the SkillFlow marketplace. Access 500+ curated, production-ready skills for Claude Code, Cursor, and other AI agents via MCP protocol.
- **Install:** `npx skillflow-mcp-server`
